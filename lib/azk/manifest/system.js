...
($traceurRuntime.createClass)(System, ($__2 = {}, Object.defineProperty($__2, "default_options", {
  ...
  configurable: true,
  enumerable: true
}), Object.defineProperty($__2, "persistent_folders", {
  get: function() {
    var $__0 = this;
    var folders = {};
  ...
  get: function() {
    var $__0 = this;
    var volumes = {};
    _.each(this.options.mount_folders, (function(target, point) {
        ...
        while (true)
          switch ($ctx.state) {
            ...
            case 8:
              ...
              break;
            case 28:
              $ctx.state = (to > 0 && this._check_dependencies(depends_instances)) ? 9 : 23;
              break;
            case 9:
              $ctx.state = 10;
  ...
  value: function(daemon) {
    ...
    run_options.local_volumes = _.merge({}, run_options.local_volumes, this.persistent_folders);
    run_options.ns = name;
    return run_options;
  },
  configurable: true,
  ...
  value: function(depends_instances) {
    var $__0 = this;
    var envs = {};
    _.each(this.depends.concat(this.name), (function(system) {
      var hosts = ($__0.manifest.system(system) || {}).hosts;
      if (!_.isEmpty(hosts)) {
