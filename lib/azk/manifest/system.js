...
($traceurRuntime.createClass)(System, ($__2 = {}, Object.defineProperty($__2, "default_options", {
      ...
      return $traceurRuntime.generatorWrap(function($ctx) {
        while (true)
          switch ($ctx.state) {
            case 0:
              $ctx.state = 2;
              return self._dependencies_instances();
            case 2:
              depends_instances = $ctx.sent;
              $ctx.state = 4;
              break;
            case 4:
              $ctx.state = (self._check_dependencies(depends_instances)) ? 5 : 21;
              break;
            case 5:
              $ctx.state = 6;
            ...
            case 12:
              ...
              break;
            case 31:
              $ctx.state = (to > 0) ? 18 : 28;
              break;
            case 18:
              $ctx.state = 19;
              return self.run(true, to, depends_instances);
            case 19:
              $ctx.maybeThrow();
              $ctx.state = 21;
              break;
            case 28:
              $ctx.state = (to < 0) ? 26 : 21;
              break;
            case 26:
            ...
            case 27:
              $ctx.state = 23;
              return self._kill_or_stop(containers);
            case 23:
              $ctx.maybeThrow();
              $ctx.state = 21;
              break;
    ...
    return async(function() {
      ...
      return $traceurRuntime.generatorWrap(function($ctx) {
        while (true)
          switch ($ctx.state) {
            case 0:
              $ctx.state = (opts.pull) ? 1 : 5;
              break;
            case 1:
              $ctx.state = 2;
              return self.image.pull(opts.pull);
            case 2:
              $ctx.maybeThrow();
              $ctx.state = 4;
              break;
  ...
  value: function() {
    var $__0 = this;
    return this.image.check().then((function(image) {
      if (image == null) {
