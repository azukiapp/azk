...
var $__7 = require('azk'),
    ...
    t = $__7.t;
var $__7 = require('vm'),
    runInNewContext = $__7.runInNewContext,
    createScript = $__7.createScript;
var System = require('azk/system').System;
var createCache = require('fscache').createSync;
var mkdir = require('mkdirp').sync;
var $__7 = require('azk/utils/errors'),
    ManifestError = $__7.ManifestError,
    ManifestRequiredError = $__7.ManifestRequiredError,
    SystemNotFoundError = $__7.SystemNotFoundError;
...
var Manifest = function Manifest(cwd) {
  ...
  if (typeof file == "boolean")
    ($__7 = [file, null], required = $__7[0], file = $__7[1], $__7);
  if (required && !cwd)
...
($traceurRuntime.createClass)(Manifest, {
  ...
  getMeta: function() {
    ...
    return ($__8 = this.meta).getOrSet.apply($__8, $traceurRuntime.toObject(args));
  },
  setMeta: function() {
    var $__8;
    for (var args = [],
    ...
    ($__8 = this.meta).set.apply($__8, $traceurRuntime.toObject(args));
    return this;
  },
  cleanMeta: function() {
    var $__8;
    ...
    return ($__8 = this.meta).clean.apply($__8, $traceurRuntime.toObject(args));
  },
  get systemDefault() {
