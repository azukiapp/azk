...
function init(cli) {
  var cmds = [(new Cmd('start [system]', cli)).addOption(['--reprovision', '-R'], {default: true}), (new Cmd('stop [system]', cli)), (new Cmd('reload [system]', cli)).addOption(['--reprovision', '-R'], {default: true})];
