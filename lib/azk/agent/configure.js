...
($traceurRuntime.createClass)(Configure, {
  ...
  darwin: function() {
    this.dns_separator = '.';
    return Q.all([this._which('VBoxManage'), this._which('unfsd'), this._checkAndConfigureNetwork(), this._checkAndGenerateSSHKeys()]);
  },
  ...
  _checkAndGenerateSSHKeys: function() {
    var $__0 = this;
    ...
    return qfs.exists(file).then((function(exist) {
      if (!exist) {
        ...
        return $__0.execSh(script).fail((function(err) {
