module.exports = function() {
  ...
  var Agent = {
    ...
    start: function(options) {
      ...
      return defer((function(resolve, reject, notify) {
        ...
        if (pid.running) {
          ...
          if (options.daemon) {
            return $__0.launchDaemon(options.configs);
          } else {
            $__0.wait = resolve;
            $__0.processWrapper(options.configs).progress(notify).fail((function(err) {
    ...
    processWrapper: function(configs) {
      var $__0 = this;
      var acc_keys = 'agent:config_keys';
      _.each(configs, (function(value, key) {
        set_config(key, value);
        set_config(acc_keys, $traceurRuntime.spread(config(acc_keys), [key]));
      }));
  ...
  if (require.main === module) {
    ...
    process.on('message', (function(msg) {
      if (msg.type = 'start') {
        Agent.processWrapper(msg.configs).fail((function(error) {
