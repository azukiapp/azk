...
var $__4 = require('azk/utils/errors'),
    InvalidOptionError = $__4.InvalidOptionError,
    RequiredOptionError = $__4.RequiredOptionError,
    InvalidValueError = $__4.InvalidValueError;
var Option = require('azk/cli/option').Option;
var $__4 = require('azk/cli/ui'),
    UIProxy = $__4.UIProxy,
    UI = $__4.UI;
...
($traceurRuntime.createClass)(Command, {
  ...
  before_action: function() {
    ...
    return ($__5 = this).action.apply($__5, $traceurRuntime.toObject(args));
  },
  run: function() {
