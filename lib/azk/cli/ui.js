...
var UI = {
  ...
  dir: function() {
    ...
    ($__10 = console).dir.apply($__10, $traceurRuntime.toObject(args));
  },
  ...
  outputWithLabel: function(rows) {
    ...
    _.each(rows, (function(row) {
      var $__10;
      ($__10 = $__0).output.apply($__10, $traceurRuntime.spread(["%s%-*s  %s", ident, row.shift(), size], row));
    }));
  },
  ok: function() {
    for (var args = [],
  ...
  newBar: function(mbar) {
    ...
    return ($__10 = mbars[mbar]).newBar.apply($__10, $traceurRuntime.toObject(args));
  },
  stdout: function() {
...
_.each(_.methods(UI), (function(method) {
  UIProxy.prototype[method] = function() {
    ...
    return ($__10 = this.userInterface)[method].apply($__10, $traceurRuntime.toObject(args));
  };
}));
module.exports = {
  get UI() {
