...
var DependencyError = function DependencyError(dependencie) {
  var data = arguments[1] !== (void 0) ? arguments[1] : {};
  $traceurRuntime.superCall(this, $DependencyError.prototype, "constructor", [("dependencies." + os.platform() + "." + dependencie)]);
  this.code = AGENT_CODE_ERROR;
  _.merge(this, data);
};
var $DependencyError = DependencyError;
($traceurRuntime.createClass)(DependencyError, {}, {}, AzkError);
