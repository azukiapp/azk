...
var OSNotSupported = function OSNotSupported(os) {
  $traceurRuntime.superCall(this, $OSNotSupported.prototype, "constructor", ['os_not_supported']);
  this.os = os;
  this.code = AGENT_CODE_ERROR;
};
var $OSNotSupported = OSNotSupported;
($traceurRuntime.createClass)(OSNotSupported, {}, {}, AzkError);
var DependencieError = function DependencieError(dependencie) {
  $traceurRuntime.superCall(this, $DependencieError.prototype, "constructor", [("dependencies." + os.platform() + "." + dependencie)]);
  this.code = AGENT_CODE_ERROR;
};
var $DependencieError = DependencieError;
($traceurRuntime.createClass)(DependencieError, {}, {}, AzkError);
...
module.exports = {
  ...
  get DependencieError() {
    return DependencieError;
  },
  get AgentStartError() {
