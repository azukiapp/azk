...
($traceurRuntime.createClass)(System, {
  ...
  runShell: function() {
    ...
    return ($__13 = Run).runShell.apply($__13, $traceurRuntime.spread([this], args));
  },
  runDaemon: function() {
    var $__13;
    for (var args = [],
    ...
    return ($__13 = Run).runDaemon.apply($__13, $traceurRuntime.spread([this], args));
  },
  runProvision: function() {
    ...
    return ($__13 = Run).runProvision.apply($__13, $traceurRuntime.spread([this], args));
  },
  stop: function() {
    var $__13;
    for (var args = [],
    ...
    return ($__13 = Run).stop.apply($__13, $traceurRuntime.spread([this], args));
  },
  instances: function() {
    var $__13;
    for (var args = [],
    ...
    return ($__13 = Run).instances.apply($__13, $traceurRuntime.spread([this], args));
  },
  start: function() {
    var $__13;
    for (var args = [],
    ...
    return ($__13 = Scale).start.apply($__13, $traceurRuntime.spread([this], args));
  },
  scale: function() {
    var $__13;
    for (var args = [],
    ...
    return ($__13 = Scale).scale.apply($__13, $traceurRuntime.spread([this], args));
  },
  killAll: function() {
    var $__13;
    for (var args = [],
    ...
    return ($__13 = Scale).killAll.apply($__13, $traceurRuntime.spread([this], args));
  },
  checkDependsAndReturnEnvs: function() {
    ...
    return ($__13 = Scale).checkDependsAndReturnEnvs.apply($__13, $traceurRuntime.spread([this], args));
  },
  get provision_steps() {
  ...
  daemonOptions: function() {
    ...
    if (options.image_data) {
      ...
      _.each(config.ExposedPorts, (function(config, port) {
        var have = _.find(options.ports, (function(value, key) {
