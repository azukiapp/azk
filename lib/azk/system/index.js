...
($traceurRuntime.createClass)(System, {
  ...
  runShell: function() {
    ...
    return ($__11 = Run).runShell.apply($__11, $traceurRuntime.spread([this], args));
  },
  runDaemon: function() {
    var $__11;
    for (var args = [],
    ...
    return ($__11 = Run).runDaemon.apply($__11, $traceurRuntime.spread([this], args));
  },
  runProvision: function() {
    ...
    return ($__11 = Run).runProvision.apply($__11, $traceurRuntime.spread([this], args));
  },
  stop: function() {
    var $__11;
    for (var args = [],
    ...
    return ($__11 = Run).stop.apply($__11, $traceurRuntime.spread([this], args));
  },
  scale: function() {
    var $__11;
    for (var args = [],
    ...
    return ($__11 = Scale).scale.apply($__11, $traceurRuntime.spread([this], args));
  },
  instances: function() {
    var $__11;
    for (var args = [],
    ...
    return ($__11 = Scale).instances.apply($__11, $traceurRuntime.spread([this], args));
  },
  killAll: function() {
    var $__11;
    for (var args = [],
    ...
    return ($__11 = Scale).killAll.apply($__11, $traceurRuntime.spread([this], args));
  },
  get provision_steps() {
