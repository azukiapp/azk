...
($traceurRuntime.createClass)(System, {
  ...
  runShell: function() {
    ...
    return ($__12 = Run).runShell.apply($__12, $traceurRuntime.spread([this], args));
  },
  runDaemon: function() {
    var $__12;
    for (var args = [],
    ...
    return ($__12 = Run).runDaemon.apply($__12, $traceurRuntime.spread([this], args));
  },
  runProvision: function() {
    ...
    return ($__12 = Run).runProvision.apply($__12, $traceurRuntime.spread([this], args));
  },
  stop: function() {
    var $__12;
    for (var args = [],
    ...
    return ($__12 = Run).stop.apply($__12, $traceurRuntime.spread([this], args));
  },
  start: function() {
    var $__12;
    for (var args = [],
    ...
    return ($__12 = Scale).start.apply($__12, $traceurRuntime.spread([this], args));
  },
  scale: function() {
    var $__12;
    for (var args = [],
    ...
    return ($__12 = Scale).scale.apply($__12, $traceurRuntime.spread([this], args));
  },
  instances: function() {
    var $__12;
    for (var args = [],
    ...
    return ($__12 = Scale).instances.apply($__12, $traceurRuntime.spread([this], args));
  },
  killAll: function() {
    var $__12;
    for (var args = [],
    ...
    return ($__12 = Scale).killAll.apply($__12, $traceurRuntime.spread([this], args));
  },
  get provision_steps() {
