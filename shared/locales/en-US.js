...
module.exports = {
  ...
  generator: {
    found              : [
      "",
      "[%(systemName)s] `%(systemName)s` system was detected at '%(dir)s'.",
    ...
    foundWithoutVersion: [
      ...
      "[%(systemName)s] `%(systemName)s` system was detected at '%(dir)s'.",
      "[%(systemName)s] The image suggested was `%(image)s`.",
      "[%(systemName)s] ! It was not possible to detect a specific version, so, the standard version was suggested instead.",
